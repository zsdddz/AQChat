...
goog.exportSymbol('proto.chat_msg.BroadcastMsgAck.User', null, global);
 ...
 * @constructor
 */
proto.chat_msg.BroadcastMsgAck.User = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.chat_msg.BroadcastMsgAck.User, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.chat_msg.BroadcastMsgAck.User.displayName = 'proto.chat_msg.BroadcastMsgAck.User';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.chat_msg.BroadcastMsgAck.toObject = function(includeInstance, msg) {
  var f, obj = {
    user: (f = msg.getUser()) && proto.chat_msg.BroadcastMsgAck.User.toObject(includeInstance, f),
    roomid: jspb.Message.getFieldWithDefault(msg, 2, 0),
    msgtype: jspb.Message.getFieldWithDefault(msg, 3, 0),
    msg: jspb.Message.getFieldWithDefault(msg, 4, "")
  };
...
proto.chat_msg.BroadcastMsgAck.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.chat_msg.BroadcastMsgAck.User;
      reader.readMessage(value,proto.chat_msg.BroadcastMsgAck.User.deserializeBinaryFromReader);
      msg.setUser(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readInt32());
...
proto.chat_msg.BroadcastMsgAck.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.chat_msg.BroadcastMsgAck.User.serializeBinaryToWriter
    );
  }
  f = message.getRoomid();
  if (f !== 0) {
 ...
 * @return {!Object}
 */
proto.chat_msg.BroadcastMsgAck.User.prototype.toObject = function(opt_includeInstance) {
  return proto.chat_msg.BroadcastMsgAck.User.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.chat_msg.BroadcastMsgAck.User} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.chat_msg.BroadcastMsgAck.User.toObject = function(includeInstance, msg) {
  var f, obj = {
    userid: jspb.Message.getFieldWithDefault(msg, 1, ""),
    username: jspb.Message.getFieldWithDefault(msg, 2, ""),
    useravatar: jspb.Message.getFieldWithDefault(msg, 3, "")
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.chat_msg.BroadcastMsgAck.User}
 */
proto.chat_msg.BroadcastMsgAck.User.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.chat_msg.BroadcastMsgAck.User;
  return proto.chat_msg.BroadcastMsgAck.User.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.chat_msg.BroadcastMsgAck.User} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.chat_msg.BroadcastMsgAck.User}
 */
proto.chat_msg.BroadcastMsgAck.User.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.chat_msg.BroadcastMsgAck.User.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.chat_msg.BroadcastMsgAck.User.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.chat_msg.BroadcastMsgAck.User} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.chat_msg.BroadcastMsgAck.User.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.chat_msg.BroadcastMsgAck.User.prototype.getUserid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.chat_msg.BroadcastMsgAck.User} returns this
 */
proto.chat_msg.BroadcastMsgAck.User.prototype.setUserid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.chat_msg.BroadcastMsgAck.User.prototype.getUsername = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.chat_msg.BroadcastMsgAck.User} returns this
 */
proto.chat_msg.BroadcastMsgAck.User.prototype.setUsername = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.chat_msg.BroadcastMsgAck.User.prototype.getUseravatar = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.chat_msg.BroadcastMsgAck.User} returns this
 */
proto.chat_msg.BroadcastMsgAck.User.prototype.setUseravatar = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
...
proto.chat_msg.BroadcastMsgAck.prototype.getUser = function() {
  return /** @type{?proto.chat_msg.BroadcastMsgAck.User} */ (
    jspb.Message.getWrapperField(this, proto.chat_msg.BroadcastMsgAck.User, 1));
};


/**
 * @param {?proto.chat_msg.BroadcastMsgAck.User|undefined} value
