...
goog.exportSymbol('proto.chat_msg.FriendOfflineAck', null, global);
 ...
 * @constructor
 */
proto.chat_msg.FriendOfflineAck = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.chat_msg.FriendOfflineAck, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.chat_msg.FriendOfflineAck.displayName = 'proto.chat_msg.FriendOfflineAck';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.chat_msg.FriendOfflineAck.prototype.toObject = function(opt_includeInstance) {
  return proto.chat_msg.FriendOfflineAck.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.chat_msg.FriendOfflineAck} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.chat_msg.FriendOfflineAck.toObject = function(includeInstance, msg) {
  var f, obj = {
    userid: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.chat_msg.FriendOfflineAck}
 */
proto.chat_msg.FriendOfflineAck.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.chat_msg.FriendOfflineAck;
  return proto.chat_msg.FriendOfflineAck.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.chat_msg.FriendOfflineAck} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.chat_msg.FriendOfflineAck}
 */
proto.chat_msg.FriendOfflineAck.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.chat_msg.FriendOfflineAck.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.chat_msg.FriendOfflineAck.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.chat_msg.FriendOfflineAck} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.chat_msg.FriendOfflineAck.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserid();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.chat_msg.FriendOfflineAck.prototype.getUserid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.chat_msg.FriendOfflineAck} returns this
 */
proto.chat_msg.FriendOfflineAck.prototype.setUserid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.chat_msg.ChatRecord.prototype.getUserid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.chat_msg.ChatRecord.prototype.setUserid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.chat_msg.ChatRecord.prototype.getUsername = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.chat_msg.ChatRecord} returns this
 */
proto.chat_msg.ChatRecord.prototype.setUsername = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.chat_msg.ChatRecord.prototype.getUseravatar = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.chat_msg.ChatRecord} returns this
 */
proto.chat_msg.ChatRecord.prototype.setUseravatar = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
